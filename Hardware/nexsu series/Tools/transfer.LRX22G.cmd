...
rem -- 4.4.4 (KTU84P) ---------------------------------------------------------
rem set     update=image-razorg-ktu84p
rem set bootloader=bootloader-deb-flo-04.02.img
rem set      radio=radio-deb-deb-z00_2.42.0_1204.img

rem -- 5.0.2 (LRX22G) ---------------------------------------------------------
    set     update=image-razorg-lrx22g
    set bootloader=bootloader-deb-flo-04.04.img
    set      radio=radio-deb-deb-z00_2.43.0_1001.img
